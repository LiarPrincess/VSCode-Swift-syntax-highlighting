...
// Test if normal string work.
print("========================")
print("=== html_is_protocol ===")
print("========================")
...
private func layout(title: String, user: User?, body: String) -> String {
  let navHtml = nav(user: user)

  let normalSingleLine = "<p id=\"abc\">BODY</p>"
  let normalMultiLine = """
    <p>BODY</p>
    """

  let hashSingleLine = #"<p id="abc">BODY</p>"#
...
private func nav(user: User?) -> String {
  let loginOrUser: String

  if let user {
    loginOrUser = #"""
      <div>
        <p>\#(user.name)</p>
        <img src="\(user.avatarURL)" alt="Alt" width="50" height="50">
      </div>
      """#
  } else {
    loginOrUser = #"""
  ...
  return #"""
    <nav class="navbar" role="navigation" aria-label="main navigation">
      <div class="navbar-brand">
        <a class="navbar-item" href="#">HTMLKit</a>
      </div>
